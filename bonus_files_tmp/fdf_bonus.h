...
/*   Updated: 2023/08/07 19:31:03 by donglee2         ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
int		choose_projection(int keycode, t_info *info);

//keyhandler.c
int		key_handler(int keycode, t_info *info, t_mlx_data *mlx_data,
			t_data *img);
...
void	increase_coordinates(t_info *info, double a);
int		win_close(t_mlx_data *mlx_data, t_info *info);
